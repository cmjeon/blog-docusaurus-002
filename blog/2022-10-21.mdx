...
[https://forum.vuejs.org/t/solved-need-a-best-way-to-rerender-a-v-for-list-of-components/53548](https://forum.vuejs.org/t/solved-need-a-best-way-to-rerender-a-v-for-list-of-components/53548)
...
1. q-list 에 :key 를 선언하고 renderKey 변수를 선언한다.
2. 자식 컴포넌트에서 reset 을 호출하면 부모컴포넌트에서 renderKey 의 값을 변경한다.
3. q-list 가 갱신된다.
