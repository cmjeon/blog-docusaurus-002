...
새로운 블로그는 [https://blog-cmjeon.vercel.app/blog](https://blog-cmjeon.vercel.app/blog) 가 되었다.

이후로는 잔잔한 수정을 하면서 과거에 썼던 블로그들을 옮겨 올 생각이다.

docusaurus 에 블로그(blog) 작성 시 쓸 수 있는 front matter 정보를 여기에 기록해둔다.

[https://docusaurus.io/docs/api/plugins/@docusaurus/plugin-content-blog#markdown-front-matter](https://docusaurus.io/docs/api/plugins/@docusaurus/plugin-content-blog#markdown-front-matter)
